      ...
      >
        ...
        />
                    ...
                    <div class="mt-3 md:mt-0">
                        <a href="{{ route('admin.option.create') }}" class="inline-block px-4 py-2 text-white duration-150 font-medium bg-indigo-600 rounded-lg hover:bg-indigo-500 active:bg-indigo-700 md:text-sm">
                            Ajouter un Bien
                        </a>
                    </div>
                </div>
                <div class="mt-12 relative h-max overflow-auto">
                    <table class="w-full table-auto text-sm">
                        ...
                        @foreach($options as $option)
                            <tr>
                                <td class="pr-6 py-4 whitespace-nowrap">{{ $option->name }}</td>
                                <td class="whitespace-nowrap text-right">
                                    <div class="inline-flex rounded-lg border border-gray-100 bg-gray-100 p-1">
                                        <a
                                            ...
                                            href="{{ route('admin.option.edit', $option) }}"
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                fill="none"
                                        ...
                                        <form
                                            ...
                                            action="{{ route('admin.option.destroy', $option) }}" method="post"
                                        >
                                            @csrf
                                            @method('delete')
