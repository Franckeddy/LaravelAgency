        ...
        <div class="mt-12 relative h-max overflow-auto">
            <table class="w-full table-auto text-sm text-center">
                ...
                <tr>
                    ...
                    <th class="py-3 pr-6">Surface</th>
                    <th class="py-3 pr-6">Prix</th>
                    <th class="py-3 pr-6">Ville</th>
                ...
                <tr>
                    <td class="pr-6 py-4 whitespace-nowrap">{{ $property->title }}</td>
                    <td class="pr-6 py-4 whitespace-nowrap">{{ $property->surface }}m2</td>
                    <td class="pr-6 py-4 whitespace-nowrap">
                        <span class="px-3 py-2 rounded-full font-semibold text-xs">
                            {{ number_format($property->price, thousands_separator: ' ') }}
                        </span>
                    </td>
                    <td class="pr-6 py-4 whitespace-nowrap">{{ $property->city }}</td>
